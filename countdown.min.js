/*
 countdown.js v2.2.2 http://countdownjs.org
...
(f=j(-a.minutes/60),a.hours-=f,a.minutes+=60*f):60<=a.minutes&&(a.hours+=h(a.minutes/60),a.minutes%=60);0>a.hours?(f=j(-a.hours/24),a.days-=f,a.hours+=24*f):24<=a.hours&&(a.days+=h(a.hours/24),a.hours%=24);0>a.days&&(f=j(-a.days/28),a.months-=f,a.days+=m(a.refMonth,f));7<=a.days&&(a.weeks+=h(a.days/7),a.days%=7);0>a.months?(f=j(-a.months/12),a.years-=f,a.months+=12*f):12<=a.months&&(a.years+=h(a.months/12),a.months%=12);10<=a.years&&(a.decades+=h(a.years/10),a.years%=10,10<=a.decades&&(a.centuries+=
h(a.decades/10),a.decades%=10,10<=a.centuries&&(a.millennia+=h(a.centuries/10),a.centuries%=10)));e&1024||(a.centuries+=10*a.millennia,delete a.millennia);e&512||(a.decades+=10*a.centuries,delete a.centuries);e&256||(a.years+=10*a.decades,delete a.decades);e&128||(a.months+=12*a.years,delete a.years);!(e&64)&&a.months&&(a.days+=m(a.refMonth,a.months),delete a.months,7<=a.days&&(a.weeks+=h(a.days/7),a.days%=7));e&32||(a.days+=7*a.weeks,delete a.weeks);e&16||(a.hours+=24*a.days,delete a.days);e&8||
(a.minutes+=60*a.hours,delete a.hours);e&4||(a.seconds+=60*a.minutes,delete a.minutes);e&2||(a.milliseconds+=1E3*a.seconds,delete a.seconds);e&1||delete a.milliseconds}finally{delete a.refMonth}return a}function d(a,b,c){var e,c=c||222;"function"===typeof a?(e=a,a=null):a instanceof Date||(a=null!==a&&isFinite(a)?new Date(a):null);"function"===typeof b?(e=b,b=null):b instanceof Date||(b=null!==b&&isFinite(b)?new Date(b):null);if(!a&&!b)return new i;if(!e)return n(new i,a||new Date,b||new Date,c);
var d;d=c&1?1E3/30:c&2?1E3:c&4?6E4:c&8?36E5:c&16?864E5:6048E5;var f=function(){e(n(new i,a||new Date,b||new Date,c))};f();return setInterval(f,d)}var j=Math.ceil,h=Math.floor,o=Math.round,k;i.prototype.toString=function(a){var b=k(this);b.length>a&&(b=b.slice(0,a));a=b.length;if(!a)return"";1<a&&(b[a-1]="and "+b[a-1]);return b.join(", ")};i.prototype.toHTML=function(a,b){var a=a||"span",c=k(this);c.length>b&&(c=c.slice(0,b));var e=c.length;if(!e)return"";for(var d=0;d<e;d++)c[d]="<"+a+">"+c[d]+"</"+
