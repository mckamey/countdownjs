...
10,10<=a.centuries&&(a.millennia+=l(a.centuries/10),a.centuries%=10)));b=0;!(d&1024)||b>=g?(a.centuries+=10*a.millennia,delete a.millennia):a.millennia&&b++;!(d&512)||b>=g?(a.decades+=10*a.centuries,delete a.centuries):a.centuries&&b++;!(d&256)||b>=g?(a.years+=10*a.decades,delete a.decades):a.decades&&b++;!(d&128)||b>=g?(a.months+=12*a.years,delete a.years):a.years&&b++;!(d&64)||b>=g?(a.months&&(a.days+=r(a.refMonth,a.months)),delete a.months,7<=a.days&&(a.weeks+=l(a.days/7),a.days%=7)):a.months&&
b++;!(d&32)||b>=g?(a.days+=7*a.weeks,delete a.weeks):a.weeks&&b++;!(d&16)||b>=g?(a.hours+=24*a.days,delete a.days):a.days&&b++;!(d&8)||b>=g?(a.minutes+=60*a.hours,delete a.hours):a.hours&&b++;!(d&4)||b>=g?(a.seconds+=60*a.minutes,delete a.minutes):a.minutes&&b++;!(d&2)||b>=g?(a.milliseconds+=1E3*a.seconds,delete a.seconds):a.seconds&&b++;if(!(d&1)||b>=g){var e=k(a,0,"milliseconds","seconds",1E3,j);if(e&&(e=k(a,e,"seconds","minutes",60,j)))if(e=k(a,e,"minutes","hours",60,j))if(e=k(a,e,"hours","days",
24,j))if(e=k(a,e,"days","weeks",7,j))if(e=k(a,e,"weeks","months",q(a.refMonth)/7,j)){var d=e,i,m=a.refMonth,n=m.getTime(),o=new Date(n);o.setUTCFullYear(m.getUTCFullYear()+1);i=Math.round((o.getTime()-n)/864E5);if(e=k(a,d,"months","years",i/q(a.refMonth),j))if(e=k(a,e,"years","decades",10,j))if(e=k(a,e,"decades","centuries",10,j))if(e=k(a,e,"centuries","millennia",10,j))throw Error("Fractional unit overflow");}}}finally{delete a.refMonth}return a}function f(a,b,c,d,g){var f,c=+c||222,d=0<d?d:NaN,
g=0<g?20>g?Math.round(g):20:0;"function"===typeof a?(f=a,a=null):a instanceof Date||(a=null!==a&&isFinite(a)?new Date(a):null);"function"===typeof b?(f=b,b=null):b instanceof Date||(b=null!==b&&isFinite(b)?new Date(b):null);if(!a&&!b)return new m;if(!f)return s(new m,a||new Date,b||new Date,c,d,g);var i;i=c&1?1E3/30:c&2?1E3:c&4?6E4:c&8?36E5:c&16?864E5:6048E5;var h,e=function(){f(s(new m,a||new Date,b||new Date,c,d,g),h)};e();return h=setInterval(e,i)}var p=Math.ceil,l=Math.floor,o;m.prototype.toString=
